...
public final class Constants {
  public static final class DriveConstants {
    ...
    public static final Rotation2d kRearRightEncoderOffset = new Rotation2d(Math.toRadians(9.141)); //Q3
    public static final Rotation2d kFrontRightEncoderOffset = new Rotation2d(Math.toRadians(160.225)); //Q4

...
public class Blue {
  public static Command BlueOuter(DriveSubsystem drive) {
    return (
      new DriveTrajectory(
  ...
  public static Command BlueMiddle(DriveSubsystem drive) {
    return (
      new DriveTrajectory(
        TrajectoryGenerator.generateTrajectory(
  ...
  public static Command BlueInner(DriveSubsystem drive) {
    return (
      new DriveTrajectory(
        TrajectoryGenerator.generateTrajectory(
          new Pose2d(0, 0, new Rotation2d(0)),
